...
const placeholderImages = [
    'https://asset.kompas.com/crops/O_yq52aGohx0fLw_Z2g_y24mGyk=/0x0:1000x667/750x500/data/photo/2021/11/12/618e0037a3219.jpg',
    'https://i.imgur.com/so72y52.jpeg',
    'https://i.imgur.com/eBv6pDa.jpeg',
    'https://i.imgur.com/s6XbK3g.jpeg',
    'https://i.imgur.com/8m5g2a5.jpeg',
    'https://i.imgur.com/xQfV8GZ.jpeg',
    'https://i.imgur.com/pDRgq8s.jpeg',
    'https://i.imgur.com/jGTEG3D.jpeg',
];
let imageCounter = 0;
...
// --- Raw CSV Data ---
const swakelolaCsvData = `"Tahun Anggaran","Kode Paket","Nama Paket","Kode RUP","K/L/PD","Nama Satker","Tipe Swakelola","Nilai Pagu","Nama Pelaksana","Nilai Total Realiasai","Sumber Dana","Status Paket"
...
const tenderCsvData = `"Tahun Anggaran","Kode Tender","Nama Paket","Kode RUP","KLPD","Nama Satker","Jenis Pengadaan","Metode Pengadaan","Nilai Pagu","Nilai HPS","Nama Pemenang","Nilai Kontrak","Nilai PDN","Nilai UMK","Sumber Dana","Jenis Kontrak","Tahap"
...
const nonTenderCsvData = `"Tahun Anggaran","Kode Paket","Nama Paket","Kode RUP","K/L/PD","Nama Satker","Jenis Pengadaan","Metode pengadaan","Nilai Pagu","Nilai HPS","Nama Pemenang","Nilai Kontrak","Nilai PDN","Nilai UMK","Sumber Dana","Status Paket"
"2025","10043285000","Jasa Konsultan Perencanaan Perpanjangan Dermaga PPI Tanjung Luar (DAK)","54503141","Provinsi Nusa Tenggara Barat","Dinas Kelautan dan Perikanan","Jasa Konsultansi Badan Usaha Non Konstruksi","Pascakualifikasi","Rp. 52.500.000,00","Rp. 52.031.472,00","","0","0","0","APBD","Paket Ditutup"
"2025","10050565000","Rehabilitasi Bendung DI Kalimantong I","56253743","Provinsi Nusa Tenggara Barat","Balai Pengelolaan Sumber Daya Air  dan Hidrologi Wilayah Sungai Pulau Sumbawa","Pekerjaan Konstruksi","Pascakualifikasi","Rp. 140.000.000,00","Rp. 140.000.000,00","ZIRWA PUTRA","139807000","139807000","139807000","APBD","Paket Sedang Berjalan"
"2025","10050571000","Perkuatan Tebing Sungai Kelurahan Bertong, Kec. Taliwang, Kab. Sumbawa Barat","56252516","Provinsi Nusa Tenggara Barat","Balai Pengelolaan Sumber Daya Air  dan Hidrologi Wilayah Sungai Pulau Sumbawa","Pekerjaan Konstruksi","Pascakualifikasi","Rp. 191.000.000,00","Rp. 191.000.000,00","Razkha global","190550000","190550000","190550000","APBD","Paket Sedang Berjalan"
"2025","10116485000","Belanja Bahan-Bahan Kimia","56816230","Provinsi Nusa Tenggara Barat","Balai Pembibitan Ternak dan Hijauan Makanan Ternak Serading","Pengadaan Barang","Pascakualifikasi","Rp. 199.765.800,00","Rp. 79.898.466,00","UD. Lawang Rea","75963960","75963960","75963960","APBD","Paket Sedang Berjalan"
"2025","10107546000","Belanja Bahan-Bahan Kimia","56816230","Provinsi Nusa Tenggara Barat","Balai Pembibitan Ternak dan Hijauan Makanan Ternak Serading","Pengadaan Barang","Pascakualifikasi","Rp. 199.765.800,00","Rp. 79.898.466,00","","0","0","0","APBD","Paket Ditutup"
"2025","10135995000","Beban Jasa Penyelenggaraan Acara Gebyar Seni Tradisi Lintas Etnis","56439788","Provinsi Nusa Tenggara Barat","Taman Budaya","Jasa Lainnya","Pascakualifikasi","Rp. 150.000.000,00","Rp. 149.988.750,00","CV MAKNA KARSA","149988750","149988750","149988750","APBD","Paket Sedang Berjalan"
"2025","10177690000","Belanja Modal Bangunan Gedung Kantor - Jasa Konsultansi Pengawasan","59572655","Provinsi Nusa Tenggara Barat","Sekretariat Dewan Perwakilan Rakyat Daerah","Jasa Konsultansi Badan Usaha Konstruksi","Pascakualifikasi","Rp. 78.916.000,00","Rp. 78.853.290,00","PT. MULTIBISNIS GLOBAL MAKMUR","0","0","0","APBD","Paket Sedang Berjalan"
"2025","10163327000","Belanja Modal Bangunan Gedung Kantor - Jasa Konsultansi Pengawasan","59572655","Provinsi Nusa Tenggara Barat","Sekretariat Dewan Perwakilan Rakyat Daerah","Jasa Konsultansi Badan Usaha Konstruksi","Pascakualifikasi","Rp. 78.916.000,00","Rp. 78.853.290,00","","0","0","0","APBD","Paket Ditutup"
"2025","10174313000","Rehabilitasi Embung Alam Berseri Desa Tampak Siring Kec. Batukliang Kab. Lombok Tengah","55194783","Provinsi Nusa Tenggara Barat","Balai Pengelolaan Sumber Daya Air dan Hidrologi Wilayah Sungai Pulau Lombok","Pekerjaan Konstruksi","Pascakualifikasi","Rp. 191.000.000,00","Rp. 190.999.812,00","","0","0","0","APBD","Paket Ditutup"
"2025","10267634000","Belanja Jasa Konsultansi Perencanaan Pembangunan Ruang Kelas Baru SMK AS SHOFWAH NW RENCO","57988787","Provinsi Nusa Tenggara Barat","Dinas Pendidikan dan Kebudayaan","Jasa Konsultansi Badan Usaha Konstruksi","Pascakualifikasi","Rp. 10.000.000,00","Rp. 10.000.000,00","CV. TRIFA JASA ARSINDO","0","0","0","APBD","Paket Sedang Berjalan"
"2025","10181287000","Belanja Jasa Konsultansi Perencanaan Pembangunan Ruang Kelas Baru SMK AS SHOFWAH NW RENCO","57988787","Provinsi Nusa Tenggara Barat","Dinas Pendidikan dan Kebudayaan","Jasa Konsultansi Badan Usaha Konstruksi","Pascakualifikasi","Rp. 10.000.000,00","Rp. 10.000.000,00","","0","0","0","APBD","Paket Ditutup"`;

// --- Data Processing ---

const parsedSwakelolaData = robustParseCsv(swakelolaCsvData);
const parsedTenderData = robustParseCsv(tenderCsvData);
const parsedNonTenderData = robustParseCsv(nonTenderCsvData);


const allSwakelolaProjects: Omit<Project, 'id'>[] = parsedSwakelolaData.map((row, i) => {
...
const allTenderProjects: Omit<Project, 'id'>[] = parsedTenderData.map((row, i) => {
    const budget = parseCurrency(row['Nilai Pagu'] || '0');
...
const allNonTenderProjects: Omit<Project, 'id'>[] = parsedNonTenderData.map((row, i) => {
    const budget = parseCurrency(row['Nilai Pagu'] || '0');
    const realization = parseCurrency(row['Nilai Kontrak'] || '0');
     let coords = generateNtbCoordinates();
    if (typeof coords.lintang !== 'number' || !isFinite(coords.lintang) || typeof coords.bujur !== 'number' || !isFinite(coords.bujur)) {
    ...
    return {
        name: row['Nama Paket'] || 'Tanpa Nama',
        type: 'Non-Tender', // Explicitly set type
        location: row['K/L/PD'] || 'Nusa Tenggara Barat',
        coordinates: coords,
        progress: budget > 0 ? Math.round((realization / budget) * 100) : 0,
        budget: budget,
        ...
        status: normalizeStatus(row['Status Paket'] || 'Perencanaan'),
        providerName: row['Nama Pemenang'] || 'Belum Ada Pemenang',
        providerAddress: row['K/L/PD'] || 'Nusa Tenggara Barat',
        opdName: row['Nama Satker'] || 'OPD Tidak Diketahui',
        imageUrl: getPlaceholderImage()
    };
});
...
export const PROJECTS: Project[] = [...allTenderProjects, ...allSwakelolaProjects, ...allNonTenderProjects]
